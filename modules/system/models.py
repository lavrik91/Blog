...
class Feedback(models.Model):
    ...
    email = models.EmailField(verbose_name='Электронный адрес (email)', max_length=255)
    context = models.TextField(verbose_name='Содержание письма')
    time_create = models.DateTimeField(verbose_name='Дата отправки', auto_now_add=True)
